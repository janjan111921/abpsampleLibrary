...
export class BookServiceProxy {
     ...
     * @return Success
     */
    getAll(filter: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetBookOutputListPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetBookOutputListPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetBookOutputListPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<GetBookOutputListPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetBookOutputListPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetBookOutputListPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(body: CreateOrEditBook | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Book/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getBookById(id: number | undefined): Observable<CreateOrEditBook> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CreateOrEditBook>><any>_observableThrow(e);
                }
            } else
                return <Observable<CreateOrEditBook>><any>_observableThrow(response_);
        }));
    }

    protected processGetBookById(response: HttpResponseBase): Observable<CreateOrEditBook> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CreateOrEditBook.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CreateOrEditBook>(<any>null);
    }
...
export class CreateOrEditBook implements ICreateOrEditBook {
    id: number | undefined;
    ...
    constructor(data?: ICreateOrEditBook) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditBook {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditBook();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditBook {
    id: number | undefined;
    title: string | undefined;
    releaseDate: moment.Moment;
    publisherName: string | undefined;
...
export class GetBookOutputList implements IGetBookOutputList {
    book: GetBookOutput;

    constructor(data?: IGetBookOutputList) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.book = _data["book"] ? GetBookOutput.fromJS(_data["book"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetBookOutputList {
        data = typeof data === 'object' ? data : {};
        let result = new GetBookOutputList();
        result.init(data);
        return result;
    }
...
export interface IGetBookOutputList {
    book: GetBookOutput;
}

export class GetBookOutputListPagedResultDto implements IGetBookOutputListPagedResultDto {
    items: GetBookOutputList[] | undefined;
    totalCount: number;

    constructor(data?: IGetBookOutputListPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(GetBookOutputList.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): GetBookOutputListPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetBookOutputListPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetBookOutputListPagedResultDto {
        const json = this.toJSON();
        let result = new GetBookOutputListPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetBookOutputListPagedResultDto {
    items: GetBookOutputList[] | undefined;
    totalCount: number;
}
