...
{
    public abstract class libraryWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static libraryWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(libraryWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<libraryDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<libraryDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<libraryDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<libraryDbContext, Task<T>> func)
        {
            T result;
